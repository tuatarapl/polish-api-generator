...
import { AccountBaseInfo, AccountHolderType, AccountInfo, AdditionalPayorIdType,
    ...
    HoldInfo, NameAddress, PayorIdType,
    SenderRecipient, TransactionCancelledInfo,
    TransactionCategory, TransactionDetail, TransactionInfo,
    TransactionInfoCard, TransactionInfoTax, TransactionInfoZUS,
    TransactionPendingInfo, TransactionRejectedInfo, TransactionScheduledInfo } from 'polish-api-model'
